      ...
      <div className={styles.container}>
        ...
        <div className={styles.flexBox}>
          <AboutCard
            ...
            desc="何よりもWeb制作はご依頼者様ありきのサービスです。お客様のご要望を最大限引き出し形にする。これを意識したサービス提供を行っております。"
            link="/services/web"
            linkText="詳しく見る"
          />
          <AboutCard
            ...
            desc="他社様と比較しても、充実したプラン・価格設定を行っております。お客様のご要望に合わせたプランをご提案いたします。"
            link="/services/web"
            linkText="なぜ可能なのか？"
          />
          <AboutCard
            ...
            desc="高品質・低価格のWeb制作を提供できる理由は、当社が持つ技術力と経験によるものです。お客様のご要望に合わせたWeb制作を行っております。"
            link="/services/web"
            linkText="詳しく見る"
          />
        </div>
